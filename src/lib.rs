...
#[derive(Debug)]
pub struct SparkPrismProcessor {
    verbose: bool,
    processed_count: usize,
}

impl SparkPrismProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SparkPrism processing");
    
    let mut processor = SparkPrismProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SparkPrismProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SparkPrismProcessor::new(false);
